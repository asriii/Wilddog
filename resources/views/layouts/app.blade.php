...
<body>
    ...
    <!-- <script type="text/javascript" src="{{ asset('lib/DataTables/dist/js/dataTables.bootstrap.min.js') }}"></script> -->
    <script type="text/javascript" src="{{ asset('lib/DataTables/dataTables.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lib/sweetalert2.js') }}"></script>
